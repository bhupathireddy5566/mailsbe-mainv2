      ...
      <div className={styles.widgetsDiv}>
        <div className={styles.widget0Div}>
          ...
          <div className={styles.socialDiv}>
            ...
            <a 
              className={styles.a3} 
              href="https://github.com/aashishpanthi"
              target="_blank"
              rel="noreferrer"
            >
              <img
        ...
        <div className={styles.widget1Div}>
          ...
          <a className={styles.career} href="/career">Career</a>
          <a className={styles.worksA} href="/works">Works</a>
          <a className={styles.features} href="/features">Features</a>
        </div>
